...
public class ReadQR extends Activity implements ZBarScannerView.ResultHandler {
    ...
    private class StudyData extends AsyncTask<String, Void, JSONObject> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            loader = new ProgressDialog(ReadQR.this);
        ...
        protected JSONObject doInBackground(String... params) {
            ...
            if (path_segments.size() > 0) {
                ...
                Toast.makeText(ReadQR.this, "Missing API key or study ID. Scanned: " + study_url, Toast.LENGTH_SHORT).show();
            }
            return null;
        }
        ...
        protected void onPostExecute(JSONObject result) {
            ...
            if (result == null) {
                AlertDialog.Builder builder = new AlertDialog.Builder(ReadQR.this);
                ...
                try {
                    ...
                    Aware.joinStudy(getBaseContext(),study_url);
